...
// Selecting by index
// Real-time data
document.getElementById("previousClose").textContent = realtimeData.previousClose // Previous Close
document.getElementById("daysRange").textContent = `${realtimeData.low} - ${realtimeData.high}` // Day's Range
...
document.getElementById("weekRange").textContent = `${mostRecentData.low} - ${mostRecentData.high}` // 52 Week Range
