...
function drawChart(chartId) {
   ...
   var data0 = google.visualization.arrayToDataTable([
    ...
    var datas = [data0, data1, data2];
     var optionsz = [options0, options1, options2];
    ...
    chart.draw(datas[counter], optionsz[counter]);
   applyNewItemsOrder(e);
...
window.onclick = function (event) {
    ...
    if (!submitButton.contains(event.target) && !dropdownContent.contains(event.target)) {
        dropdownContent.style.display = "none";
    }
}
